...
class OCThread {
  public:
    ...
    OC_INLINE void start (ThreadMain start_routine, void* data);
...
OC_INLINE void* ThreadMainLoop (void* data)
{
...
OC_INLINE void OCThread::start (ThreadMain start_routine, void* data)
{
  started_ = true;
...
OC_INLINE void* OCThread::join ()
{
  ...
  int ret = pthread_join(tid_, (void**)&tmld);
