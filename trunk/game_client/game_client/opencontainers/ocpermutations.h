...
class PermutationsT {
  ...
  public:
    ...
    PermutationsT (const OCArray<T>& data):
    ...
    OCArray<T>& currentPermutation ()  { return currentPermutation_; }
  ...
  protected:
    ...
    OCArray<T> currentPermutation_;

    // The data to permute
    const OCArray<T> data_;
}; 
